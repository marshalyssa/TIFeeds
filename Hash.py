...
# List of .intel files containing hash-based indicators
intel_files = [
...
# Save all rows to a single all_hashes.csv file
with open("all_hashes.csv", mode='w', newline='', encoding='utf-8') as all_csv_file:
...
print("Merged all hashes into all_hashes.csv")
